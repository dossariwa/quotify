        ...
        <div class="flex h-16 shrink-0 items-center">
          <NavbarLink class="flex">
            <img
              ...
              alt="Quotify"
            />
            <span class="text-2xl font-bold ml-1 mt-1">Quotify</span
      ...
      >
        ...
        <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
          ...
          <div class="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <NavbarLink
              href="/login"
              class="text-sm font-semibold leading-6 text-gray-800 px-2"
              >Login</NavbarLink
            >
            <NavbarLink
              href="/signup"
